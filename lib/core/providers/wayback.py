...
class BaseEnumerateUrls:
    ...
    def extract_urls(self, response):
        ...
        try:
            if "Domain not found" in out["verbose_msg"]:
                print("\033[1m[\033[91mError\033[0m\033[1m]: Domain not found, Please double check your target domain\033[0m")
                sys.exit(1)
            else:
    ...
    def vt_apikey(self):
        ...
        try:
            ...
            print("\033[1m[\033[91mError\033[0m\033[1m]: The apikey.json file is not in the path\033[0m")
            exit(1)
